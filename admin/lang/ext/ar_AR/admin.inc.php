...
$lang['admin']['modulehelp_yourlang'] = 'العرض في لغتك';
...
$lang['admin']['general_operation_settings'] = 'عملية إعدادات العامة';
...
$lang['admin']['filterapplied'] = 'تصفية الحالية';
$lang['admin']['automatedtask_success'] = 'Automated task performed';
$lang['admin']['siteprefsupdated'] = 'تحديث إعدادات الموقع';
$lang['admin']['ip_addr'] = 'عنوان IP';
$lang['admin']['warn_admin_ipandcookies'] = 'تحذير : استخدام الكوكيز الأنشطة الادارية والمسارات عنوان IP الخاص بك';
$lang['admin']['event_desc_loginfailed'] = 'فشل تسجيل الدخول';
$lang['admin']['modulehelp_english'] = 'عرض في اللغة الإنجليزية';
$lang['admin']['nopluginabout'] = 'لا يوجد معلومات المتوفرة عن هذا الموقع';
$lang['admin']['nopluginhelp'] = 'لايوجد مساعدة متاحة لهذا البرنامج';
$lang['admin']['moduleupgraded'] = 'ترقية ناجحة';
$lang['admin']['added_css'] = 'أضاف الأنماط';
$lang['admin']['toggle'] = 'تبديل';
$lang['admin']['added_group'] = 'أضاف مجموعة';
$lang['admin']['expanded_xml'] = 'موسعة تتكون من ملف XML %s %s';
$lang['admin']['installed_mod'] = 'تثبيت الإصدار %s';
$lang['admin']['uninstalled_mod'] = 'إلغاء المودول %s';
$lang['admin']['upgraded_mod'] = '%s ترقية من الإصدار %s to %s';
$lang['admin']['edited_gcb'] = 'بلوك تحرير المحتوى الرئيسي';
$lang['admin']['edited_content'] = 'تحرير المحتوى';
$lang['admin']['added_content'] = 'أضافة المحتوى';
$lang['admin']['added_css_association'] = 'إضافة مجموعة الستايل';
$lang['admin']['deleted_group'] = 'حذف المجموعة';
$lang['admin']['deleted_content'] = 'حذف المحتوى';
$lang['admin']['edited_user'] = 'تعديل المستخدم';
$lang['admin']['edited_udt'] = 'تعديل تعريف بطاقة العضو';
$lang['admin']['content_copied'] = 'المادة التي تم نسخها إلى المحتوى %s';
$lang['admin']['deleted_template'] = 'حذف القالب';
$lang['admin']['added_udt'] = 'إضافة تعريف بطاقة العضو ';
$lang['admin']['deleted_udt'] = 'حذف تعريف بطاقة العضو';
$lang['admin']['added_gcb'] = 'إضافة شامل محتوى البلوك ';
$lang['admin']['edited_group'] = 'تعديل المجموعة';
$lang['admin']['deleted_css_association'] = 'حذف مجموعة الستايل';
$lang['admin']['user_logout'] = 'خروج المستخدم';
$lang['admin']['user_login'] = 'دخول المستخدم';
$lang['admin']['login_failed'] = 'فشل دخول المستخدم';
$lang['admin']['deleted_css'] = 'حذف الستايل';
$lang['admin']['uploaded_file'] = 'تحميل الملف';
$lang['admin']['created_directory'] = 'إنشاء دليل';
$lang['admin']['deleted_file'] = 'حذف الملف';
$lang['admin']['deleted_directory'] = 'حذف الدليل';
$lang['admin']['edited_template'] = 'تعديل القالب';
$lang['admin']['deleted_user'] = 'حذف المستخدم';
$lang['admin']['deleted_module'] = 'إزالة بشكل دائم %s';
$lang['admin']['deleted_gcb'] = 'حذف شامل المحتوى البلوك';
$lang['admin']['added_user'] = 'إضافة عضو';
$lang['admin']['edited_user_preferences'] = 'تعديل خصائص المستخدم';
$lang['admin']['added_template'] = 'إضافة قالب';
$lang['admin']['event_desc_stylesheetpostcompile'] = 'أرسلت بعد جمعها عن طريق عامة معد الشكل هندى';
$lang['admin']['event_desc_stylesheetprecompile'] = 'أرسلت قبل تجميعها عن طريق بصفة عامة معد الشكل هندى';
$lang['admin']['confirm_uploadmodule'] = 'هل أنت متأكد من أنك ترغب في تحميل الملف المحدد XML. يجوز بشكل غير صحيح تحميل ملف وحدة الخروج من الموقع يعمل';
$lang['admin']['error_module_mincmsversion'] = 'هذا النموذج يتطلب إصدار أحدث مصنوع CMS بسيط';
$lang['admin']['info_browser_cache_expiry'] = 'حدد المدة الزمنية (بالدقائق) التي يجب أن المتصفحات صفحات للالتخزين المؤقت. تعيين هذه القيمة إلى 0 تعطيل الأداء الوظيفي';
$lang['admin']['browser_cache_expiry'] = 'المتصفح مدة انتهاء العرض <em>التخزين المؤقت (دقائق)</em>';
$lang['admin']['info_browser_cache'] = 'ينطبق فقط على صفحات cachable، وهذا يشير إلى أن الإعداد يجب السماح لمتصفحات ذاكرة التخزين المؤقت صفحات لفترة من الوقت. إذا يمكن للزوار تكرار لتتمكن منالموقع لا يرى فورا تغييرات في مضمون الصفحات';
$lang['admin']['allow_browser_cache'] = 'يسمح المتصفح إلى صفحات التخزين المؤقت';
$lang['admin']['server_cache_settings'] = 'الإعدادات سيرفر ذاكرة التخزين المؤقت';
$lang['admin']['browser_cache_settings'] = 'الإعدادات المتصفح ذاكرة التخزين المؤقت';
...
$lang['admin']['info_target'] = 'يمكن يستخدم هذا الخيار من قبل إدارة القائمة للإشارة إلى متى وكيف يجب فتح إطارات جديدة أو النوافذ. قد تكون بعض القوالب إدارة القائمة تجاهل هذا الخيار.';
$lang['admin']['close'] = 'أغلق';
$lang['admin']['revert'] = 'عودة كافة التغييرات';
$lang['admin']['autoclearcache2'] = 'إزالة ملفات التخزين المؤقت التي تكون أقدم من عدد الأيام المحدد';
$lang['admin']['root'] = 'أساسي';
$lang['admin']['info_content_autocreate_flaturls'] = 'إذا كان تفعيل، سيتم إنشاء جميع عناوين المواقع على نسخة من الصفحة الاسم المستعار (ولكن غير متزامنة إلى الاسم المستعار الصفحة)';
$lang['admin']['content_autocreate_flaturls'] = 'إنشاء تلقائيا رابط  مسطح';
$lang['admin']['content_autocreate_urls'] = 'إنشاء تلقائيا رابط الصفحة  ';
$lang['admin']['content_mandatory_urls'] = 'يطلب رابط الصفحة';
$lang['admin']['content_imagefield_path'] = 'المسار لمجال الصورة';
$lang['admin']['info_content_imagefield_path'] = 'بالنسبة لتحميل الصور المسار ، حدد اسم الدليل الذي يحتوي على مسارات الملفات التي تحتوي على صورة لهذا المجالالحقل';
$lang['admin']['content_thumbnailfield_path'] = 'مسار حقل صورة مصغرة';
$lang['admin']['info_content_thumbnailfield_path'] = 'بالنسبة إلىتحميل الصور المسار ، حدد اسم الدليل الذي يحتوي على المسارات التي تحتوي على ملفات لهذا الحقل الصورة. وهذا عادة ما يكون نفس المسار أعلاه.';
$lang['admin']['contentimage_path'] = 'Path for {content_image} tag';
$lang['admin']['info_contentimage_path'] = 'بالنسبة إلىمسار تحميل، تحديد اسم الدليل الذي يحتوي على المسارات التي تحتوي على ملفات على {content_image} العلامة. وتستخدم هذه القيمة بوصفها الافتراضية للمعيار ';
$lang['admin']['editcontent_settings'] = 'الإعدادات محتوى تعديل';
$lang['admin']['help_page_url'] = 'تحديد رابط البديل (نسبة إلى أصل موقعك الإلكتروني) التي يمكن استخدامها لتحديد بشكل فريد هذه الصفحة. أي أن : مسار / إلى / صفحتي. رابط الصفحة هي مفيدة فقط عندما يتم تمكين عناوين جميلة.';
$lang['admin']['help_page_alias'] = 'وتستخدم الاسم المستعار كبديل إلى معرف بشكل فريد لتحديد الصفحة . يجب أن تكون فريدة من نوعها في جميع الصفحات. كما يستخدم الاسم المستعار للمساعدة في بناء رابط للصفحة';
$lang['admin']['help_page_searchable'] = 'هذا الإعداد يشير إلى ما إذا كان يجب أن تتم فهرسة محتويات هذه الصفحة من خلال وحدة البحث';
$lang['admin']['help_page_cachable'] = 'ويمكن زيادة الأداء بواسطة تحديد العديد من الصفحات ممكن إلىcachable. لكن هذا لا يمكن أن تستخدم لصفحات المحتوى، حيث يمكن تغيير على أساس الطلب في';
$lang['admin']['sitedownexcludeadmins'] = 'استبعاد المستخدمين تسجيل الدخول إلى وحدة تحكم المشرف CMSMS';
$lang['admin']['your_ipaddress'] = 'عنوان IP الخاص بك';
$lang['admin']['use_wysiwyg'] = 'استخدام WYSIWYG';
$lang['admin']['contenttype_redirlink'] = 'إعادة توجيه الرابط';
$lang['admin']['yes'] = 'نعم';
$lang['admin']['no'] = 'لا';
$lang['admin']['listcontent_showalias'] = 'عرض &quot;الاسم المستعار&quot; العمود';
$lang['admin']['listcontent_showurl'] = 'عرض &quot;URL&quot; العمود';
$lang['admin']['listcontent_showtitle'] = 'عرض عنوان الصفحة أو نص القائمة';
$lang['admin']['listcontent_settings'] = 'الإعدادات قائمة المحتوى';
$lang['admin']['lctitle_page'] = 'عنوان العناصر المحتوى الموجود';
$lang['admin']['lctitle_alias'] = 'الاسم المستعار من العناصر المحتوى الموجود. بعض عناصر المحتوى لم يكن لديك أسماء مستعارة';
$lang['admin']['lctitle_url'] = 'رابط  الخاص بالعنصر المحتوى. إذا كان محدد';
$lang['admin']['lctitle_template'] = 'القالب المحدد الخاص بالعنصر المحتوى. بعض عناصر المحتوى ليس لديهم قوالب';
$lang['admin']['lctitle_owner'] = 'صاحب عنصر المحتوى';
$lang['admin']['lctitle_active'] = 'يشير إلى ما إذا كان المحتوى هو العنصر النشط. لا يمكن العناصر غير نشطة عرضه.';
$lang['admin']['lctitle_default'] = 'تحديد عنصر المحتوى التي يتم الوصول إليها عند طلب رابط . يمكن أن يكون عنصر واحد فقط الافتراضي';
$lang['admin']['lctitle_move'] = 'ترتيب التسلسل  يسمح المحتوى الخاص بك';
$lang['admin']['lctitle_multiselect'] = 'تحديد كافة العناصر الموجودة / حدد أي';
$lang['admin']['invalid_url'] = 'عنوان الرابط الصفحة المحددة غير صالحة. يجب أن تحتوي على أحرف أبجدية رقمية فقط، أو -- أو /. من المحتمل ايضا تأكد من أن الرابط المحدد قيد الاستخدام مسبقا.';
$lang['admin']['page_url'] = 'رابط الصفحة';
$lang['admin']['runuserplugin'] = 'قم بتشغيل البرنامج المساعد المستخدم';
$lang['admin']['output'] = 'الإخراج';
$lang['admin']['run'] = 'قم بتشغيل';
$lang['admin']['run_udt'] = 'قم بتشغيل هذه العلامة تعريف المستخدم';
$lang['admin']['stylesheetcopied'] = 'صفحة الأنماط التي تم نسخها';
$lang['admin']['templatecopied'] = 'القوالب التي تم نسخها';
$lang['admin']['ecommerce_desc'] = 'نماذج لتقديم إمكانيات التجارة الإلكترونية';
$lang['admin']['ecommerce'] = 'التجارة الالكترونية';
...
$lang['admin']['error_parsing_content_blocks'] = 'حدث خطأ أثناء توزيع المحتوى البلوك (أسماء بلوكات مكررة ربما)';
$lang['admin']['error_no_default_content_block'] = 'لم يتم اكتشاف أي بلوك محتوى الافتراضي في هذا القالب. الرجاء التأكد من أن لديك {محتوى}العلامة في قالب الصفحة.';
...
$lang['admin']['pseudocron_granularity'] = 'Pseudocron التفاصيل';
$lang['admin']['info_pseudocron_granularity'] = 'هذه الإعداد تشير إلى عدد المرات التي سيقوم النظام المحاولة لمعالجة المهام المجدولة بانتظام';
$lang['admin']['cron_request'] = 'كل طلب';
$lang['admin']['cron_15m'] = '15 دقيقة';
$lang['admin']['cron_30m'] = '30 دقيقة';
$lang['admin']['cron_60m'] = '1 ساهة';
$lang['admin']['cron_120m'] = '2 ساعة';
$lang['admin']['cron_3h'] = '3 ساعة';
$lang['admin']['cron_6h'] = '6 ساعة';
$lang['admin']['cron_12h'] = '12 ساعة';
$lang['admin']['cron_24h'] = '24 ساعة';
$lang['admin']['adminlog_1day'] = '1 يوم';
$lang['admin']['adminlog_1week'] = '1 اسبوع';
$lang['admin']['adminlog_2weeks'] = '2 اسبوع';
$lang['admin']['adminlog_1month'] = '1 شهر';
$lang['admin']['adminlog_3months'] = '3 شهر';
$lang['admin']['adminlog_6months'] = '6 شهر';
$lang['admin']['adminlog_manual'] = 'دليل المحذوفات';
$lang['admin']['adminlog_lifetime'] = 'مدة - المقالات';
$lang['admin']['info_adminlog_lifetime'] = 'قم بإزالة المقالات ، التي هي أقدم من الفترة المحددة.';
$lang['admin']['filteruser'] = 'اسم المستخدم هو';
$lang['admin']['filtername'] = 'يحتوي على اسم الحدث';
$lang['admin']['filteraction'] = 'يحتوي على الإجراءات';
$lang['admin']['filterapply'] = 'تطبيق الفلاتر';
$lang['admin']['filterreset'] = 'إعادة ضبط الفلاتر';
$lang['admin']['filters'] = 'فلاتر';
$lang['admin']['showfilters'] = 'عرض الفلاتر';
$lang['admin']['clearcache_taskdescription'] = 'تنفيذ اليومي، فإن هذه المهمة مسح الملفات ذاكرة التخزين المؤقت التي تكون قديمة في المفضلة شامل';
$lang['admin']['clearcache_taskname'] = 'نسخة ملفات واضحة';
$lang['admin']['info_autoclearcache'] = 'تحديد قيمة عدد صحيح. ضع 0 لتعطيل التلقائي مسح ذاكرة التخزين المؤقت';
$lang['admin']['autoclearcache'] = 'مسح ذاكرة التخزين المؤقت تلقائيا كل يوم ';
$lang['admin']['listtemplates_pagelimit'] = 'عدد الصفوف لكل صفحة أثناء عرض القوالب';
$lang['admin']['liststylesheets_pagelimit'] = 'عدد الصفوف لكل صفحة أثناء عرض معدات الشكل';
$lang['admin']['listgcbs_pagelimit'] = 'عدد الصفوف لكل صفحة أثناء عرض المحتوى بلوكات شامل';
$lang['admin']['insecure'] = 'غير آمن (HTTP)';
$lang['admin']['secure'] = 'آمن (HTTPS)';
$lang['admin']['secure_page'] = 'استخدام HTTPS لهذه الصفحة';
$lang['admin']['thumbnail_width'] = 'عرض مصغرة';
$lang['admin']['thumbnail_height'] = 'الارتفاع مصغرة';
$lang['admin']['E_STRICT'] = 'هي E_STRICT معطلة في error_reporting';
$lang['admin']['test_estrict_failed'] = 'يتم تمكين E_STRICT في error_reporting';
$lang['admin']['info_estrict_failed'] = 'بعض المكتبات التي تستخدم CMSMS لا تعمل بشكل جيد مع E_STRICT. يرجى تعطيل هذه قبل المتابعة';
$lang['admin']['E_DEPRECATED'] = 'هي E_DEPRECATED معطلة في error_reporting';
$lang['admin']['test_edeprecated_failed'] = 'تم تمكين E_DEPRECATED';
$lang['admin']['info_edeprecated_failed'] = 'وفي حالة تمكين المستخدمين E_DEPRECATED في الإعلام عن الأخطاء نرى الكثير من رسائل التحذير التي قد تؤثر على عرض وظائف';
$lang['admin']['session_use_cookies'] = 'يسمح للدورات في استخدام الكوكيز';
$lang['admin']['errorgettingcontent'] = 'لا تستطيع استرجاع المعلومات عن موضوع المحتوى المحدد';
$lang['admin']['errordeletingcontent'] = 'خطأ حذف محتوى (إما هذه الصفحة تمت الأطفال أو المحتوى الافتراضي)';
$lang['admin']['invalidemail'] = 'عنوان البريد الإلكتروني الذي أدخلته غير صحيح';
$lang['admin']['info_deletepages'] = 'ملاحظة : قد لا يعود الى القيود تصريح، بعض الصفحات التي اختيرت لتكون الحذف المذكورة أدناه';
$lang['admin']['info_pagealias'] = 'تحديد الاسم المستعار فريدة من نوعها لهذه الصفحة.';
$lang['admin']['info_autoalias'] = 'إذا كان هذا الحقل فارغا، سيتم إنشاء اسم مستعار تلقائيا.';
$lang['admin']['invalidparent'] = 'يجب تحديد صفحة رئيسية (اتصل بالمسؤول إذا كنت لا ترى هذا الخيار).';
$lang['admin']['forgotpwprompt'] = 'أدخل اسم المستخدم الخاص بك المسؤول. وبعد ذلك يتم إرسال رسالة بالبريد الالكتروني إلى عنوان البريد الإلكتروني المقترن مع اسم المستخدم معلومات تسجيل الدخول الجديدة';
$lang['admin']['info_basic_attributes'] = 'هذا الحقل يسمح لك لتحديد الخصائص التي يتم المحتوى الذي يسمح للمستخدمين من دون تصريح &quot;إدارة جميع محتويات&quot; لتحريره. سوف تظهر خصائص محددة في &quot;الجدولة الرئيسية&quot; على صفحة محتوى تحريرها.';
$lang['admin']['basic_attributes'] = 'الخصائص الاساسية';
$lang['admin']['no_permission'] = 'لايوجد لديك الإذن لتنفيذ هذه الوظيفة.';
$lang['admin']['bulk_success'] = 'تم عملية التحديث بنجاح';
$lang['admin']['no_bulk_performed'] = 'لا يتم تنفيذ العملية.';
$lang['admin']['info_preview_notice'] = 'تحذير : هذه لوحة المعاينة تتصرف مثل الكثير من نافذة المتصفح مما يتيح لك التنقل بعيدا عن الصفحة مخططا في البداية. ومع ذلك ، إذا كنت تفعل ذلك ، قد تواجه سلوك غير متوقع. إذا كنت تنقل بعيدا عن العرض الأولي وبالمقابل ، قد لا تتمكن من رؤية المحتوى من UN وملتزم حتى قمت بإجراء تغيير في المحتوى في علامة الرئيسية ومن ثم تحميل هذا التبويب. عند إضافة المحتوى ، وإذا كنت التنقل بعيدا عن هذه الصفحة ، فلن تتمكن من العودة، ويجب تحديث هذه اللوحة.';
$lang['admin']['sitedownexcludes'] = 'استثناء هذه العناوين من الموقع لأسفل الرسائل';
...
$lang['admin']['setup'] = 'برنامج الإعداد المتقدمة';
$lang['admin']['handle_404'] = '404 المخصصة معالجة';
$lang['admin']['sitedown_settings'] = 'اعدادات الموقع الاسفل';
$lang['admin']['general_settings'] = 'إعدادات عامة';
...
$lang['admin']['forge'] = 'صياغة';
$lang['admin']['disable_wysiwyg'] = 'تعطيل محرر WYSIWYG في هذه الصفحة (بغض النظر عن القالب أو إعدادات المستخدم)';
...
$lang['admin']['pagelink_circular'] = 'يمكن لارتباط الصفحة قائمة عدم رابط آخر الصفحة كما وجهتها';
$lang['admin']['destinationnotfound'] = 'لا يمكن العثور على الصفحة التي يتم اختيارها أو غير صالحة';
...
$lang['admin']['sqlerror'] = 'SQL الخطأ في ٪ s';
$lang['admin']['image'] = 'صورة';
$lang['admin']['thumbnail'] = 'مصغرة';
$lang['admin']['searchable'] = 'هذه الصفحة هي للبحث';
...
$lang['admin']['error_udt_name_chars'] = 'اسم UDT صحيحة يبدأ بحرف أو تسطير، تليها أي عدد من الحروف والأرقام، أو يؤكد.';
$lang['admin']['errorupdatetemplateallpages'] = 'القالب غير فعال';
$lang['admin']['hidefrommenu'] = 'إخفاء من القائمة';
$lang['admin']['settemplate'] = 'ضبط القالب';
$lang['admin']['text_settemplate'] = 'ضبط صفحات المحددة لقالب  أخر';
$lang['admin']['cachable'] = 'Cachable';
$lang['admin']['noncachable'] = 'لا Cachable';
$lang['admin']['copy_from'] = 'نسخة من';
$lang['admin']['copy_to'] = 'نسخة إلى';
$lang['admin']['copycontent'] = 'نسخ محتويات الموضوع';
$lang['admin']['md5_function'] = 'md5 وظيفة';
$lang['admin']['tempnam_function'] = 'tempnam وظيفة';
$lang['admin']['register_globals'] = 'PHP register_globals';
$lang['admin']['output_buffering'] = 'PHP output_buffering';
$lang['admin']['disable_functions'] = 'disable_functions في PHP';
$lang['admin']['xml_function'] = 'الاساسية XML (الوافدين) الدعم';
$lang['admin']['magic_quotes_gpc'] = 'عروض أسعار على ماجيك احصل على وظيفة/ كوكي / ';
$lang['admin']['magic_quotes_gpc_on'] = 'ونجا واحد الاقتباس ، الاقتباس المزدوجة والخط المائل العكسي تلقائيا. يمكن تواجهك مشاكل عند الحفظ القوالب';
$lang['admin']['magic_quotes_runtime'] = 'علامات الاقتباس في زمن التشغيل ماجيك';
$lang['admin']['magic_quotes_runtime_on'] = 'هرب معظم الوظائف التي سيكون لها عودة البيانات علامات الاقتباس مع الخط المائل العكسي. ويمكنك واجهت مشاكل';
$lang['admin']['file_get_contents'] = 'تجربة file_get_contents';
$lang['admin']['check_ini_set'] = 'تجربة ini_set';
$lang['admin']['check_ini_set_off'] = 'قد يكون لديك صعوبة في بعض الوظائف دون هذه الإمكانية. قد تفشل إذا هذا الاختبار تم تمكين الوضع الامن';
$lang['admin']['file_uploads'] = 'تحميل الملف';
$lang['admin']['test_remote_url'] = 'اختبار رابط عن بعد';
$lang['admin']['test_remote_url_failed'] = 'ومن المحتمل غير قادر على فتح ملف موجود على خادم الويب من بعد.';
...
$lang['admin']['unlimited'] = 'غير محدود';
...
$lang['admin']['files_not_found'] = 'لم يتم العثور على ملفات';
...
$lang['admin']['days'] = 'أيام';
$lang['admin']['day'] = 'يوم';
$lang['admin']['hours'] = 'ساعات';
$lang['admin']['hour'] = 'ساعة';
$lang['admin']['minutes'] = 'دقائق';
$lang['admin']['minute'] = 'دقيقة';
...
';
$lang['admin']['login_info_title'] = 'معلومات';
...
$lang['admin']['user_tag'] = 'مستخدم العلامات';
$lang['admin']['add'] = 'إضافة';
$lang['admin']['CSS'] = 'CSS الستايل';
$lang['admin']['about'] = 'عن';
$lang['admin']['action'] = 'إجراء';
$lang['admin']['actionstatus'] = 'إجراءات / الحالة';
$lang['admin']['active'] = 'النشطة';
$lang['admin']['addcontent'] = 'إضافة محتوى جديد';
$lang['admin']['cantremove'] = 'لا يمكن إزالة';
$lang['admin']['changepermissions'] = 'تغيير صلاحيات';
...
$lang['admin']['back'] = 'العودة إلى القائمة';
$lang['admin']['backtoplugins'] = 'العودة إلى قائمة الإضافات';
$lang['admin']['cancel'] = 'إلغاء';
...
$lang['admin']['canceldescription'] = 'تجاهل التغييرات';
...
$lang['admin']['content'] = 'محتويات';
$lang['admin']['contentmanagement'] = 'إدارة محتويات';
$lang['admin']['contenttype'] = 'نوع محتويات';
$lang['admin']['copy'] = 'نسخة';
$lang['admin']['copytemplate'] = 'نسخ قالب';
$lang['admin']['create'] = 'إنشاء';
$lang['admin']['createnewfolder'] = 'إنشاء مجلد جديد';
$lang['admin']['cssalreadyused'] = 'CSS name already in use';
$lang['admin']['cssmanagement'] = 'إدارة CSS';
$lang['admin']['currentassociations'] = 'الجمعيات الحالية';
...
$lang['admin']['custom404'] = 'رسالة خطأ 404 مخصصة';
$lang['admin']['database'] = 'قاعدة البيانات';
$lang['admin']['databaseprefix'] = 'Database Prefix';
$lang['admin']['databasetype'] = 'نوع قاعدة البيانات';
$lang['admin']['date'] = 'تاريخ';
$lang['admin']['default'] = 'الافتراضية';
...
$lang['admin']['deletecss'] = 'حذف CSS';
$lang['admin']['dependencies'] = 'Dependencies';
$lang['admin']['description'] = 'الوصف';
$lang['admin']['directoryexists'] = 'هذا الدليل موجود بالفعل.';
$lang['admin']['down'] = 'أسفل';
$lang['admin']['edit'] = 'تحرير';
$lang['admin']['editconfiguration'] = 'تعديل الإعدادات';
$lang['admin']['editcontent'] = 'تعديل محتويات';
$lang['admin']['editcss'] = 'Edit Stylesheet';
$lang['admin']['editcsssuccess'] = 'Stylesheet updated';
$lang['admin']['editgroup'] = 'تعديل الفريق';
$lang['admin']['editpage'] = 'تعديل الصفحة';
$lang['admin']['edittemplate'] = 'تعديل قالب';
$lang['admin']['edittemplatesuccess'] = 'قالب تم تحديث';
$lang['admin']['edituser'] = 'تعديل مستخدم';
...
$lang['admin']['email'] = 'العنوان الإلكتروني';
...
$lang['admin']['errorcopyingtemplate'] = 'خطأ نسخ قالب';
...
$lang['admin']['errorcreatingassociation'] = 'خطأ في إنشاء الجمعيات';
...
$lang['admin']['errordeletingassociation'] = 'خطأ حذف الجمعيات';
$lang['admin']['errordeletingcss'] = 'خطأ حذف css';
...
$lang['admin']['mediatype'] = 'نوع الملف';
...
$lang['admin']['stylesheetexists'] = 'تم ادخال هذا الستايل';
$lang['admin']['errorcopyingstylesheet'] = 'خطـأ خلال نسخ الستايل';
$lang['admin']['copystylesheet'] = 'نسخ الستايل';
$lang['admin']['newstylesheetname'] = 'اسم الستايل الجديد';
$lang['admin']['target'] = 'الهدف';
$lang['admin']['xml'] = 'XML';
...
';
$lang['admin']['filterbymodule'] = 'فلتر المودول';
$lang['admin']['showall'] = 'اظهار الجميع';
$lang['admin']['core'] = 'قلب';
$lang['admin']['defaultpagecontent'] = 'محتوى الصفحة الافتراضية';
$lang['admin']['file_url'] = 'رابط الملف (عوضا عن URL) ';
$lang['admin']['no_file_url'] = 'لا شيء (Use URL Above)';
$lang['admin']['defaultparentpage'] = 'اصل الصفحة الافتراضية';
$lang['admin']['error_udt_name_whitespace'] = 'خطأ : في اسم المستخدم لا يمكن أن يكون مسافات في الاسم.';
...
$lang['admin']['test'] = 'اختبار';
$lang['admin']['results'] = 'النتائج';
$lang['admin']['untested'] = 'لا يوجد اختبار';
$lang['admin']['unknown'] = 'غير معروف';
$lang['admin']['download'] = 'تنزيل';
$lang['admin']['frontendwysiwygtouse'] = 'الواجهة WYSIWYG';
$lang['admin']['all_groups'] = 'جميع المجموعات';
$lang['admin']['error_type'] = 'نوع الخطأ';
$lang['admin']['contenttype_errorpage'] = 'صفحة الخطأ';
$lang['admin']['errorpagealreadyinuse'] = 'Error Code Already in Use';
$lang['admin']['404description'] = 'لم يتم العثور على الصفحة';
$lang['admin']['usernotfound'] = 'لم يتم العثور على المستخدم.';
$lang['admin']['passwordchange'] = 'من فضلك ، اطلب كلمة مرور جديدة';
$lang['admin']['recoveryemailsent'] = 'أرسل بريد إلكتروني إلى العنوان المسجل. يرجى مراجعة صندوق البريد الوارد لمزيد من التعليمات.';
$lang['admin']['errorsendingemail'] = 'كان هناك خطأ في إرسال البريد الإلكتروني. اتصل بالمسؤول.';
$lang['admin']['passwordchangedlogin'] = 'Password changed.  Please log in using the new credentials.';
$lang['admin']['nopasswordforrecovery'] = 'لا يوجد عنوان البريد الإلكتروني المحدد لهذا المستخدم. استعادة كلمة السر غير ممكن. الرجاء الاتصال مع بالمسؤول.';
$lang['admin']['lostpw'] = 'نسيت كلمة السر؟';
$lang['admin']['lostpwemailsubject'] = '[s٪] استعادة كلمة السر';
...
$lang['admin']['utma'] = '156861353.499333077.1311594186.1311594186.1311594186.1';
$lang['admin']['utmz'] = '156861353.1311594186.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['admin']['qca'] = 'P0-1393246855-1304498842364';
