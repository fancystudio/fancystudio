...
$lang['admindescription'] = 'AceEditor je <em>Syntaxhighlighter</em> modul koji koristi <strong>Ace</strong>, editor koda pisan u JavaScript-u.';
$lang['settings_tab'] = 'Prefrencije';
$lang['frontendsettings_tab'] = 'Preferencije za korisnički deo';
...
$lang['width_title'] = '&Scaron;irina editora (u em)';
$lang['height_title'] = 'Visina editora (u em)';
$lang['enable_ie'] = 'Omogući i za Internet Explorer';
$lang['enable_iedescription'] = '<em>Ace Syntaxhighlighter</em> ne radi ba&scaron; najbolje u Internet Exploreru. Ovu opciju uključite na sopstveni rizik!';
$lang['frontend_width_title'] = '&Scaron;irina za korisnički deo (u px)';
$lang['frontend_height_title'] = 'Visina za korisnički deo (u px)';
$lang['syntax_mode'] = 'Mod rada';
$lang['themes'] = 'Tema';
$lang['font_size'] = 'Veličina fonta';
$lang['full_line'] = 'Selektuj celu liniju';
$lang['highlight_active'] = 'Označi aktivnu liniju';
$lang['show_invisibles'] = 'Prikaži nevidljive karaktere';
$lang['persistent_hscroll'] = 'Persitent HScroll';
$lang['key_binding'] = 'Key Binding';
$lang['soft_wrap'] = 'Prelamanje linija';
$lang['show_gutter'] = 'Prikaži <em>Gutter</em>';
$lang['print_margin'] = 'Prikaži marginu za &scaron;tampu';
$lang['soft_tab'] = 'Use Soft Tab';
$lang['highlight_selected'] = 'Označi selektovanu reč';
$lang['enable_behaviors'] = 'Enable Behaviors';
$lang['testareatext'] = 'Pregled';
$lang['js'] = 'JavaScript';
$lang['plain'] = 'Obični tekst';
$lang['svg'] = 'SVG';
$lang['html'] = 'HTML';
$lang['css'] = 'CSS';
$lang['scss'] = 'SCSS';
...
$lang['vim'] = 'Vim';
$lang['emacs'] = 'EMacs';
$lang['custom'] = 'Korisnički definisano';
$lang['off'] = 'Isključeno';
$lang['40'] = '40 karaktera';
$lang['80'] = '80 karaktera';
$lang['100'] = '100 karaktera';
$lang['140'] = '140 karaktera';
$lang['savesettings'] = 'Sačuvaj pode&scaron;avanja';
$lang['settingssaved'] = 'Va&scaron;a pode&scaron;avanja AceEditora su sačuvana';
$lang['frontendsettingssaved'] = 'Va&scaron;a pode&scaron;avanja AceEditora za korisnički deo sajta su sačuvana';
$lang['postinstall'] = 'AceEditor je uspe&scaron;no instaliran! Podesite &quot;Menjanje pode&scaron;avanja sajta&quot; dozvole da biste koristili ovaj modul.';
$lang['postuninstall'] = 'AceEditor je uspe&scaron;no deinstaliran';
$lang['really_uninstall'] = 'Stvarno? Sigurni ste da želite da deinstalirate AceEditor? Razmislite jo&scaron; jednom...';
...
$lang['help_param_width'] = 'određuje &scaron;irinu Syntaxhighlighter u pikselima.';
$lang['help_param_height'] = 'određuje visinu Syntaxhighlighter u pikselima.';
$lang['help_param_divid'] = 'ID elementa koji sadrži Va&scaron; kod. Koristite jedinstvenu ID oznaku za svaki komad koda.';
$lang['help_general_title'] = 'Op&scaron;ta';
$lang['help_general_text'] = '<h3>&Scaron;ta ovo radi?</h3>
<p>AceEditor je Syntaxhighlighter modul koji koristi <strong>Ace</strong> editor koda pisan u JavaScript-u.<br /> 
Namjera grupe koja razvija Ace editor koda je stvaranje editora koda namenjenog Vebu koji ima iste i čak bolje mogućnosti, upotrebljivost i performanse kao postojeći editor tipa TextMate, Vim ili Eclipse.<br />
Lako se može implementirari u bilo koju Veb stranicu i JavaScript aplikaciju.<br /> 
Ace je razvijan kao primarni editor za <a href="http://www.cloud9ide.com">Cloud9 IDE</a> i naslednik je Mozilla Skywriter (Bespin) Projekta.</p>
<h3>Ace je hostovan na GitHub-u</h3>
<p>Izvorni kod Ace editora je hostovan na GitHub-u. Podleže trostrukoj Mozilla licenci (MPL/GPL/LGPL).<br />
Istu licencu koristi Firefox. Ova licenca je naklonjena svim vrstama projekata, bilo da su <em>open source</em> ili ne.<br />
 Take charge of your editor and add your favorite language highlighting and keybindings!</p>
<h3>Kako se koristi?</h3>
<p>Upoteba AceEditor Modula je prosta.<br />
Nakon &scaron;to instalirate AceEditor idite na &quot;Moje preferencije &raquo; Korisničke preferencije&quot; i izaberite AceEditor kao Va&scaron; <em>syntaxhighlighter</em> u &quot;Izaberite syntax highlighter za upotrebu:&quot; padajućoj listi.<br />
Postarajte se da imate dozvolu &quot;Menjanje pode&scaron;avanja sajta&quot;.</p>
<h3>Pode&scaron;avanja</h3>
<p>Možete promeniti podrazumevana pode&scaron;avanja i teme nako odete na &quot;Ekstenzije &raquo; AceEditor&quot;</p>';
$lang['help_keyboardshortcuts_title'] = 'Prečice na tastaturi';
$lang['help_keyboardshortcuts_content'] = '      <h3>Podrazumenane prečice na tastaturi</h3>
...
$lang['help_frontend_title'] = 'Korisnički deo';
...
$lang['help_about_title'] = 'O modulu';
$lang['help_about_text'] = '<h3>Podr&scaron;ka</h3>
<p>U skladu sa GPL, ovaj softver Vam je pružen &quot;u viđenom stanju&quot;. Molimo pročitajte licencu za čitavu izjavu o odricanju od odgovornosti.</p>
...
$lang['utma'] = '156861353.347894210.1327320010.1327320010.1327320010.1';
$lang['utmz'] = '156861353.1327320010.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['utmb'] = '156861353';
$lang['utmc'] = '156861353';
?>