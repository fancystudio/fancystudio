<?php
    ...
    $srcImgSizeArray = array();
		...
		if ($imgcount > 0)
          ...
          list($width, $height, $type, $attr) = getimagesize($gCms->config['uploads_url'].$this->getAssetPath('s').'/'.$params['alias'].
			     '_src_'.$i.'.jpg');  
    ...
    $this->smarty->assign('alias',$params['alias']);
        ...
        $this->smarty->assign_by_ref('src_image_size_array',$srcImgSizeArray);
		$this->smartyBasics();
