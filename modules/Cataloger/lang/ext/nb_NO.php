...
$lang['namefiles'] = 'Filer';
$lang['namefile'] = 'Fil';
$lang['deleteimage'] = 'Slett bilder';
$lang['deletefile'] = 'Slett fil';
$lang['Owner'] = 'Eier';
$lang['CatalogItem'] = 'Artikkel katalog';
$lang['namepage'] = 'Side';
$lang['Permissions'] = 'Rettigheter';
$lang['Sub'] = 'Under -';
$lang['title_global_item_sort_order2'] = 'Artikkel sorterings rekkef&oslash;lge';
$lang['title_global_items_per_page2'] = 'Artikler pr side';
$lang['title_global_category_recurse2'] = 'Visnings oppf&oslash;rsel';
$lang['which_attributes'] = 'Hvilke attributter skal vises i katalogen';
$lang['navTab'] = '  | ';
$lang['needpermission'] = 'Du trenger %s satt for &aring; gj&oslash;re det.';
$lang['friendlyname'] = 'Cataloger ';
$lang['admindescription'] = 'Behandle Catalog innstillnger';
$lang['areyousure'] = 'Er du sikker p&aring; at du vil slette dette %s?';
$lang['uniquecode'] = 'Unik kode';
$lang['templatelist'] = 'Sub-maler';
$lang['listtempl'] = 'Behandle sub-maler';
$lang['title_field_type'] = 'Felttype';
$lang['title_select_values'] = 'Velg verdier*';
$lang['title_item_tab'] = 'Artikkel kjennetegn';
$lang['title_category_tab'] = 'Kategori kjennetegn';
$lang['title_printable_tab'] = 'Utskrivbar Katalog innstillinger';
$lang['title_item_image_tab'] = 'Artikkel Bilde st&oslash;rrelse';
$lang['title_category_image_tab'] = 'Kategori side innstillinger';
$lang['title_path_tab'] = 'Stier';
$lang['title_delete'] = 'Slette?';
$lang['title_file_tab'] = 'Andre filinnstillinger';
$lang['title_image_tab'] = 'Andre bildeinnstillinger';
$lang['title_item_template_vars'] = 'Artikkel mal variabler';
$lang['title_cat_template_vars'] = 'Kategori mal variabler';
$lang['title_catalog_template_vars'] = 'Catalogmal variabler';
$lang['title_compare_template_vars'] = 'Sammenligningsmal variabler';
$lang['title_feature_template_vars'] = 'Egenskapslistemal variabler';
$lang['title_show_only_existing_images'] = 'Ikke inkluder manglende bilder';
$lang['title_show_only_existing_images_help'] = 'Dette vil kun sette bildereferanser inn i listene om bildet eksisterer.<br />(Normalt er dette bra, men om du gj&oslash;r noe smart med bildet<br />indekseres arrayet, dette kan gi deg tr&oslash;bbel.)';
$lang['title_flush_cats'] = 'T&oslash;m kategoriside bufre';
$lang['title_flush_cats_help'] = 'Om du har et stort antall enheter vist<br />i en kategori, vil noen PHP installasjoner feile &aring; vise siden<br />korrekt. Hak av i denne boksen for &aring; l&oslash;se dette problemet (test for eventuelle bi-effekter).';
$lang['title_item_file_types'] = 'Tillatte filtyper';
$lang['title_image_upload_path'] = 'Plassering for opplastede bildefiler';
$lang['title_file_upload_path'] = 'Plassering for andre opplastede ertikkelbildefiler';
$lang['title_image_proc_path'] = 'Plassering for behandlede bilder (miniatyrbilder, skalerte bilder, osv.)';
$lang['path_help'] = 'Du kan spesifisere hvor Cataloger lagrer filer. Disse stiene er relative til <i>uploads_path</i> definert i din config.php<br />MERK: Om du endrer disse stiene etter at filer eller bilder har blitt lastet opp, s&aring; vil Cataloger miste &#039;allerede opplastet&#039; egenskapen (de vil fortsatt v&aelig;re der, men Cataloger vil ikke vite om dem, s&aring; du m&aring; laste dem opp p&aring; ny for at Cataloger skal klare &aring; finne det ut).';
$lang['cataloger'] = 'Cataloger ';
$lang['title_attr_order_by'] = 'Rekkef&oslash;lge';
$lang['title_attr_alias'] = 'Attributt alias (Smarty-vennlig)';
$lang['title_attr_length'] = 'Lengde*';
$lang['title_attr_default'] = 'Standard verdi';
$lang['title_attr_length_help'] = '(*Lengde har ikke innvirkning p&aring; Tekstomr&aring;der)';
$lang['text'] = 'Tekst';
$lang['dropdown'] = 'Nedtrekk';
$lang['textarea'] = 'Tekstomr&aring;de';
$lang['checkbox'] = 'Avkrysningsboks';
$lang['item_page'] = 'Artikkel side';
$lang['category_page'] = 'Kategori side';
$lang['catalog_printable'] = 'Utskrivbar Katalog';
$lang['catalog_datasheet'] = 'Katalog datablad';
$lang['catalog_short_list'] = 'Egenskap liste';
$lang['item_comparison'] = 'Artikkel sammenligning';
$lang['title_global_item_sort_order'] = 'Sett artikkel sortering rekkef&oslash;lge til';
$lang['title_global_items_per_page'] = 'Sett antall artikler pr side til';
$lang['title_global_category_recurse'] = 'Sett kategori visning oppf&oslash;rsel til';
$lang['title_item_sort_order'] = 'Standard artikkel sorteringsrekkef&oslash;lge';
$lang['title_printable_sort_order'] = 'Standard utskrivbar katalog sorteringsrekkef&oslash;lge';
$lang['title_items_per_page'] = 'Standard antall artikler pr side';
$lang['title_avail_attrs'] = 'Artikkel attributter tilgjengelig for malen';
$lang['title_avail_imattrs'] = 'Artikkelbilder tilgjengelig for malen';
$lang['title_item_image_size_hero'] = 'Bildest&oslash;rrelse for artikkel side (lang akse i pixler)';
$lang['title_item_image_size_thumbnail'] = 'Thumbnail bildest&oslash;rrelse for artikkelside (lang akse i pixler)';
$lang['title_item_image_size_category'] = 'Thumbnail bildest&oslash;rrelse for artikkel p&aring; kategoriside (lang akse i pixler)';
$lang['title_item_image_size_catalog'] = 'Thumbnail bildest&oslash;rrelse for artikkel p&aring; katalogside (long axis in pixels)';
$lang['title_category_image_size_hero'] = 'Bilde st&oslash;rrelse for kategoriside (lang akse i pixler)';
$lang['title_category_image_size_thumbnail'] = 'Thumbnail bildest&oslash;rrelse for kategoriside (lang akse i pixler)';
$lang['title_template'] = 'Mal';
$lang['title_template_type'] = 'Mal type';
$lang['title_title'] = 'Tittel';
$lang['title_item_image_count'] = 'Maksimum antall visninger for hver artikkel';
$lang['title_item_file_count'] = 'Maksimum antall andre filer assosiert med hver artikkel';
$lang['title_category_image_count'] = 'Maksimum antall banner-bilder for hver kategoriside';
$lang['title_item_attributes_help'] = 'Hver attributt du angir her vil bli tittel p&aring; et felt som du kan bruke til &aring; beskrive en individuell artikkel og vil bli vist ved denne artikkel. Du m&aring; kanskje oppdatere din mal for &aring; reflektere disse attributter. Blank ut eller skriv over en eksisterende attributt for &aring; fjerne eller bytte den ut.';
$lang['title_category_attributes_help'] = 'Hver attributt du angir her vil bli tittel p&aring; et felt som du kan bruke til &aring; beskrive en individuell artikkel kategori og vil bli vist p&aring; denne kategorisiden. Du m&aring; kanskje oppdatere din mal for &aring; reflektere disse attributter.';
$lang['title_catalog_attributes_help'] = 'Hver attributt du angir her vil bli tittel p&aring; et felt som du kan bruke til &aring; beskrive hele katalogen og vil bli vist p&aring; den skrivbare katalogsiden. Du m&aring; kanskje oppdatere din mal for &aring; reflektere disse attributter.';
$lang['title_category_sort'] = 'Kategoriside artikkel-liste sorteringsrekkef&oslash;lge';
$lang['title_category_recurse'] = 'Standard kategori visnings oppf&oslash;rsel';
$lang['title_category_recurse_items_all'] = 'Inkluder alle artikler innefor denne kategori, inkludert artikler i under-kategorier';
$lang['title_category_recurse_items_one'] = 'Inkluder alle artikler i akkurat denne kategori, men ikke fra under-kategorier';
$lang['title_category_recurse_categories_all'] = 'Inkluder alle kategorier innenfor denne kategorien, inkludert innen under-kategorier';
$lang['title_category_recurse_categories_one'] = 'Inkluder alle kategorier i akkurat denne kategorien, men ikke kategorier i under-kategorier';
$lang['title_category_recurse_mixed_all'] = 'Inkluder alle artikler og kategorier i denne kategorien, inkludert artikler og kategorier i under-kategorier';
$lang['title_category_recurse_mixed_one'] = 'Inkluder alle artikler og kategorier i akkurat denne kategorien, men ikke artikler og kategorier i under-kategorier';
$lang['title_show_missing_images'] = 'Vis &quot;Ingen bilde&quot; bilde for manglende bilder';
$lang['title_show_missing_images_long'] = 'Vis et spesielt &quot;Ingen Bilde&quot; bilde om det mangler bilder (ellers blir det brukt et en-pixel transparent bilde).';
$lang['natural_order'] = 'Navigerings-rekkef&oslash;lge';
$lang['alpha_order'] = 'Alfabetisk rekkef&oslash;lge';
$lang['manageprefs'] = 'Behandle innstillinger';
$lang['manageattrs'] = 'Behandle brukerdefinerte attributter';
$lang['globalops'] = 'Global katalog handlinger';
$lang['addtemplate'] = 'Legg til mal';
$lang['reimporttemplates'] = 'Gjen-inporter eksempel under-maler';
$lang['reimported'] = 'Eksempel under-maler har blitt importerte';
$lang['templateupdated'] = 'Mal lag til/oppdatert.';
$lang['templatedeleted'] = 'Mal slettet.';
$lang['prefsupdated'] = 'Innstillinger har blitt oppdatert.';
$lang['installed'] = 'Module versjon %s innstallert.';
$lang['upgraded'] = 'Modul oppgradert til versjon %s.';
$lang['badfile'] = 'Filen &quot;%s&quot; er ikke av et godkjent format.';
$lang['badimage'] = 'Problem med &aring; laste opp &quot;%s&quot; (sjekk filst&oslash;rrelse og/eller rettigheter p&aring; server).';
$lang['badimageformat'] = '&quot;%s&quot; er ikke gyldig. Kun jpeg-filer er st&oslash;ttet akkurat n&aring;.';
$lang['uploaded'] = 'Filen &quot;%s&quot; lastet opp for artikkel %s.';
$lang['uninstalled'] = 'Modul avinstallert.';
$lang['attrsupdated'] = 'Attributter oppdatert';
$lang['noglobalchange'] = 'Ikke endre';
$lang['globallyupdated'] = 'Endringer forplantet globalt';
$lang['edittemplate'] = 'Rediger mal';
$lang['subtemplates'] = 'Katalog under-maler';
$lang['next'] = ':&raquo;';
$lang['prev'] = '&laquo;:';
$lang['edit'] = 'Rediger';
$lang['delete'] = 'Slett';
$lang['notemplates'] = 'Ingen under-maler er installert!';
...
$lang['postinstall'] = 'Husk &aring; sette &quot;Modify Catalog Settings&quot; rettighet til brukere som skal administrere katalogen.';
...
$lang['utma'] = '156861353.179052623084110100.1210423577.1290554042.1290627362.3417';
$lang['qca'] = '1210971690-27308073-81952832';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353.2.10.1290627362';
?>