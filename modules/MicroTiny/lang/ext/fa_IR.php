<?php
$lang['show_statusbar'] = 'نمایش نوار وظیفه';
$lang['help_show_statusbar'] = 'Enable a status bar on the bottom of the wysiwyg area.  This is applicable only in an admin view.';
$lang['allow_resize'] = 'موافق تغییر اندازه';
$lang['help_allow_resize'] = 'Allow resizing of the wysiwyg area.  Requires that the statusbar be enabled';
$lang['view_html'] = 'نمایش کد HTML';
$lang['friendlyname'] = 'ویراشگر MicroTiny WYSIWYG';
$lang['help'] = '<h3>این ماژول چکار می&zwnj;کند ؟</h3>
MicroTiny یک ویرایشگر کوچک شده از نسخه اصلی ویراشگر TinyMCE-editor می&zwnj;باشد که ساختار درج مطالب در ساده نویس را بصورت پیشفرض دارد.
این ویرایشگر امکانات بسیار زیادی ندارد اما می&zwnj;تواند برای تغییرات اولیه در متن&zwnj;ها مورد استفاده قرار گرفته شود. اما به سادگی صفحات را ویرایش می&zwnj;کند.';
$lang['example'] = 'MicroTiny example';
$lang['settings'] = 'تنظیم&zwnj;ها';
$lang['youareintext'] = 'شما در اینجا هستید ';
$lang['dimensions'] = 'WxH';
$lang['size'] = 'اندازه';
